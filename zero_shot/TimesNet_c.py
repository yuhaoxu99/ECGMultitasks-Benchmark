...
projection = nn.Linear(500, 15).to("cuda")
...
def parse_args():
    ...
    parser.add_argument("--file_path", type=str, default="/vast/yx3534/PhyFM/instruct_data/mimic_ecg.jsonl", help="Path to the JSONL file containing the dataset")
